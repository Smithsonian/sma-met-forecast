#!/usr/bin/env python
#
# gfs15_to_am10.py - For a given site latitude, longitude, and altitude, this
...
#
# This version is for GFSv.15 grib2 data, and writes layer date for am-10.0
...
CYCLE_REQUEST_FORMAT = "&dir=%2Fgfs.{0}%2F{1:02d}"
